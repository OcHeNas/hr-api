...
Revision ID: 1bae80657c7b
Revises: 
Create Date: 2024-03-18 23:54:18.752739
...
def upgrade() -> None:
    ...
    op.create_table('appilicant',
                    sa.Column('id_appilicant', sa.Integer(), autoincrement=True, nullable=False),
